...
pq_handshake_test_vectors = [
    ...
    {
        "client_ciphers": "KMS-PQ-TLS-1-0-2019-06",
        "server_ciphers": "KMS-PQ-TLS-1-0-2019-06",
        "expected_cipher": "ECDHE-BIKE-RSA-AES256-GCM-SHA384",
        "expected_kem": "BIKE1r1-Level1",
    },
    {
        "client_ciphers": "KMS-PQ-TLS-1-0-2019-06",
        "server_ciphers": "KMS-PQ-TLS-1-0-2020-02",
        "expected_cipher": "ECDHE-BIKE-RSA-AES256-GCM-SHA384",
        "expected_kem": "BIKE1r1-Level1",
    },
    {
        "client_ciphers": "KMS-PQ-TLS-1-0-2020-02",
        "server_ciphers": "KMS-PQ-TLS-1-0-2020-02",
        "expected_cipher": "ECDHE-BIKE-RSA-AES256-GCM-SHA384",
    ...
    {
        "client_ciphers": "PQ-SIKE-TEST-TLS-1-0-2019-11",
        "server_ciphers": "KMS-PQ-TLS-1-0-2019-06",
    ...
    {
        "client_ciphers": "PQ-SIKE-TEST-TLS-1-0-2020-02",
        "server_ciphers": "KMS-PQ-TLS-1-0-2019-06",
        "expected_cipher": "ECDHE-SIKE-RSA-AES256-GCM-SHA384",
        "expected_kem": "SIKEp503r1-KEM",
    },
    ...
    {
        "client_ciphers": "KMS-PQ-TLS-1-0-2019-06",
         "server_ciphers": "KMS-TLS-1-0-2018-10",
    ...
    {
        "client_ciphers": "KMS-TLS-1-0-2018-10",
        "server_ciphers": "KMS-PQ-TLS-1-0-2019-06",
        "expected_cipher": "ECDHE-RSA-AES256-GCM-SHA384",
        "expected_kem": "NONE",
    },
...
def test_pq_handshake(managed_process, vector):
    ...
    client_options = ProviderOptions(
        ...
        insecure=True,
        cipher=None,
        extra_flags=['--ciphers', vector['client_ciphers']],
    ...
    server_options = ProviderOptions(
        ...
        port=port,
        cipher=None,
        extra_flags=['--ciphers', vector['server_ciphers']],
        protocol=Protocols.TLS12)
